<?php
$pageTitle = 'Privacy Policy - TechDetector';
...
<head>
    ...
    <meta name="description" content="Read our Privacy Policy to understand how TechDetector collects, uses, and protects your information.">
    ...
    <style>
        ...
        .prose h1 {
            @apply text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 text-center;
        }
        .prose h2 {
            @apply text-2xl md:text-3xl font-semibold text-gray-800 dark:text-gray-100 mt-8 mb-4 pb-2 border-b border-gray-200 dark:border-gray-700;
            scroll-margin-top: 1rem;
        }
        .prose p {
            @apply text-gray-600 dark:text-gray-300 leading-relaxed mb-4 text-base md:text-lg;
        }
        .prose ul {
            @apply list-disc pl-6 mb-6 space-y-2;
        }
        .prose li {
            @apply text-gray-600 dark:text-gray-300 text-base md:text-lg;
        }
        .prose a {
            @apply text-blue-600 dark:text-blue-400 hover:underline transition-colors duration-200;
        }
        .last-updated {
            @apply text-gray-500 dark:text-gray-400 text-center mb-8 text-sm md:text-base;
        }
        .container {
...
<header class="bg-white dark:bg-gray-800 shadow-sm">
    <div class="container mx-auto px-4">
        <nav class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="../terms/" class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 <?= $currentPage === 'terms' ? 'font-medium text-blue-600 dark:text-blue-400' : '' ?>">
                   Terms
                </a> 
    ...
    <div id="mobile-menu" class="md:hidden hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white dark:bg-gray-800 shadow-lg">
            ...
            <a href="terms" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                Terms of Service
            </a>
            <div class="px-3 py-2">
    ...
    <main class="min-h-[calc(100vh-4rem)] w-full bg-gray-50 dark:bg-gray-900 py-8">
        <div class="h-full w-full flex items-center justify-center px-4">
            <div class="w-full max-w-6xl bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden flex flex-col" style="max-height: calc(100vh - 8rem);">
                <div class="px-6 py-8 sm:p-10 overflow-y-auto flex-1">
                    <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-6 text-center">Privacy Policy</h1>
                    <p class="text-gray-500 dark:text-gray-400 text-center mb-8 text-sm">Last updated: <?= date('F j, Y') ?></p>

                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">1. Information We Collect</h2>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">We collect information that you provide directly to us when you use our Service, including when you:</p>
                    ...
                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">2. How We Use Your Information</h2>
                    ...
                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">3. Information Sharing</h2>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">We do not share your personal information with third parties except in the following cases:</p>
                        <ul class="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2 mb-4">
                    ...
                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">4. Data Security</h2>
                    ...
                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">5. Your Rights</h2>
                    ...
                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">6. Cookies and Tracking Technologies</h2>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">
                    ...
                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">7. Changes to This Policy</h2>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">
                    ...
                    <section>
                        ...
                        <div class="mt-4 space-y-2">
                            <p class="flex items-center">
                                ...
                                <a href="mailto:otienobrian029@gmail.com" class="text-blue-600 dark:text-blue-400 hover:underline">otienobrian029@gmail.com</a>
                            </p>
                            <p class="flex items-center">
                                <i class="fas fa-map-marker-alt text-blue-500 mr-2"></i>
                                <span class="text-gray-600 dark:text-gray-300">Nairobi, Kenya</span>
                            </p>
                        </div>
                    </section>
                        ...
                        <section class="mb-8">
                            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">5. Third-Party Services</h2>
                            <p class="text-gray-600 dark:text-gray-300 mb-4">
                                We may use third-party services to help us operate our business. These third parties have access to your information only to perform specific tasks on our behalf and are obligated not to disclose or use it for any other purpose.
                            </p>
                        </section>

                        <section class="mb-8">
                            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">6. Your Rights</h2>
                            <p class="text-gray-600 dark:text-gray-300 mb-4">You have the right to:</p>
                            <ul class="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2 mb-4">
                        ...
                        <section>
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mt-2">
                                Email: privacy@techdetector.app<br>
    ...
    <div class="container mx-auto px-4 py-12 md:py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="relative group">
                ...
                <ul class="space-y-2">
                    <li><a href="" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 transition-colors duration-200">Privacy Policy</a></li>
                    <li><a href="../terms" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 transition-colors duration-200">Terms of Service</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-opacity-20 border-gray-400 dark:border-gray-600 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-500 dark:text-gray-400 text-sm mb-4 md:mb-0">
                ...
                <a href="terms" clas../s="te/xt-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 text-sm font-medium transition-all hover:translate-x-0.5">
                    Terms of Service
                </a>
                <span class="text-gray-300 dark:text-gray-600">•</span>
...
<!-- Back to top button -->
<button id="back-to-top" class="fixed bottom-8 right-8 bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full shadow-lg transition-all duration-300 opacity-0 invisible">
    ...
    <script>
        ...
        if (localStorage.getItem('color-theme') === 'dark' || (!localStorage.getItem('color-theme') && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
            ...
            if (mobileThemeIcon) mobileThemeIcon.setAttribute('d', 'M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z');
        } else {
            document.documentElement.classList.remove('dark');
            if (themeToggleDarkIcon) themeToggleDarkIcon.classList.remove('hidden');
            if (mobileThemeIcon) mobileThemeIcon.setAttribute('d', 'M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z');
        }
        ...
        document.addEventListener('click', (e) => {
            if (mobileMenuButton && mobileMenu && !mobileMenuButton.contains(e.target) && !mobileMenu.contains(e.target)) {
